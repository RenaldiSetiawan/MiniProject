...
export default function NavigationBar(props) {
    ...
    return (
        <>
            <nav className=" top-0 fixed z-50 w-full bg-white shadow" >
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        <div className="flex items-center">
                            <div className="flex-shrink-0">
                                <a href="/hr/">  
                                <img className="h-8 w-8" src={logo} alt="Tour Travel" />
                                </a>
                            </div>
                            <div className="hidden md:block">
                                <div className="ml-3 flex items-baseline space-x-1">

                                    <a href="#" className={active === "dashboard" ? activeClass : disactiveClass} onClick={() => setActive("dashboard")}>Tour Travel Full Stack</a>
